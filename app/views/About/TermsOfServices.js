  ...
  return (
    <View style={{ flex: 1, backgroundColor: themes[theme].backgroundColor }}>
      ...
      <View style={[styles.container, { marginBottom: 0 }]}>
        <Text style={[styles.headerTitle, { color: themes[theme].titleColor }]}>Terms of Use</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Updated at 2021-09-27</Text>
      </View>
      <ScrollView style={[styles.container, { marginBottom: 32 }]}>
        <Text style={[styles.title, { color: themes[theme].titleColor, marginTop: 16 }]}>
          General Terms
        </Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          By accessing and placing an order with VIP Billionaires, you confirm that you are in agreement with and bound by the terms of
          ...
          of communication between you and VIP Billionaires.
        </Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          Under no circumstances shall VIP Billionaires team be liable for any direct, indirect, special, incidental or consequential
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          VIP Billionaires will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions, please do not use the VIP Billionaires Service. In these Terms & Conditions, "you"
        ...
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
          ● Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Zein El Dine International Co., Ltd, Tokyo, Japan that is responsible for your information under this Terms
          & Conditions.
        </Text>
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
          ● Country: where VIP Billionaires or the owners/founders of VIP Billionaires are based, in this case is Japan</Text>
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
          ● Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit VIP Billionaires and use the services.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
        ...
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
          ...
          our content or whose products or services we think may interest you.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor, marginBottom: 0 }]}>
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>We've updated our Terms & Conditions to provide you with complete transparency into what is being set when
          you visit our site
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          This Terms & Conditions applies only to the Services. The Services may contain links to other websites not operated or controlled by VIP Billionaires. We are not responsible for the content,
          accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to
          go from the Services to another website, our Terms & Conditions are no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform,
          is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.
        </Text>

        <Text style={[styles.title, { color: themes[theme].titleColor }]}>Cookies</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          VIP Billionaires uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece of data stored on your computer or mobile device by your web browser. We
          use Cookies to enhance the performance and functionality of our app but are non-essential to their use. However, without these cookies, certain functionality like videos may become
          unavailable or you would be required to enter your login details every time you visit the app as we would not be able to remember that you had logged in previously. Most web browsers can be
          set to disable the use of Cookies. However, if you disable Cookies, you may not be able to access functionality on our website correctly or at all. We never place Personally Identifiable
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          ...
          prior notice to you. You may stop using the Service at any time. You do not need to specifically inform when you stop using the Service. You acknowledge and agree that if disables access to
          your account, you may be prevented from accessing the Service, your account details or any files or other materials which is contained in your account.
        </Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>You further agree that all Updates will be (i) deemed to constitute an integral part of the app, and (ii)
          subject to the terms and
          conditions of this Agreement.</Text>
        <Text style={[styles.title, { color: themes[theme].titleColor }]}>Third-Party Services</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>We may display, include or make available third-party content (including data, information, applications
          and other products
          services) or provide links to third-party websites or services ("Third- Party Services").</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>You acknowledge and agree that VIP Billionaires shall not be responsible for any Third-Party Services,
          ...
          Services.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Third-Party Services and links thereto are provided solely as a convenience to you and you access and use
          them entirely at
          your own risk and subject to such third parties' terms and conditions.</Text>
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>VIP Billionaires may, in its sole discretion, at any time and for any or no reason, suspend or terminate
          this Agreement with or
          without prior notice.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>This Agreement will terminate immediately, without prior notice from VIP Billionaires, in the event that
          ...
          computer.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Upon termination of this Agreement, you shall cease all use of the app and delete all copies of the app
          from your computer.
          ...
          you (during the term of this Agreement) of any of your obligations under the present Agreement.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Copyright Infringement Notice</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>If you are a copyright owner or such owner’s agent and believe any material on our app constitutes an
          ...
          is accurate, and, under penalty of perjury you are authorized to act on behalf of the owner.</Text>
        <Text style={[styles.title, { color: themes[theme].titleColor }]}>Indemnification</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>You agree to indemnify and hold VIP Billionaires and its parents, subsidiaries, affiliates, officers,
          ...
          use of the app; (b) violation of this Agreement or any law or regulation; or (c) violation of any right of a third party.</Text>
        <Text style={[styles.title, { color: themes[theme].titleColor }]}>No Warranties</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>The app is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of
          any kind. To the
          ...
          errors or defects can or will be corrected.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          Without limiting the foregoing, neither VIP Billionaires nor any VIP Billionaires's provider makes any representation or warranty of any kind, express or implied: (i) as to the operation or
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Some jurisdictions do not allow the exclusion of or limitations on implied warranties or the limitations
          on the applicable statutory
          rights of a consumer, so some or all of the above exclusions and limitations may not apply to you.</Text>
        <Text style={[styles.title, { color: themes[theme].titleColor }]}>Limitation of Liability</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Notwithstanding any damages that you might incur, the entire liability of VIP Billionaires and any of its
          suppliers under any
          ...
          for the app.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>To the maximum extent permitted by applicable law, in no event shall VIP Billionaires or its suppliers be
          ...
          such damages and even if the remedy fails of its essential purpose.</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Some states/jurisdictions do not allow the exclusion or limitation of incidental or consequential
          damages, so the above limitation
          or exclusion may not apply to you.</Text>
        ...
        <Text style={[styles.text, { color: themes[theme].textColor }]}>● Via Email: info@zedinternational.net</Text>
      </ScrollView>
    </View>
  )
}
