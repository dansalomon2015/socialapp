...
const EditPostView = props => {
  ...
  return (
    <View
      ...
      <KeyboardView
        contentContainerStyle={[sharedStyles.contentContainer, { flex: 1, overflow: 'hidden', paddingTop: 20, paddingHorizontal: 10, backgroundColor: themes[theme].backgroundColor }]}
