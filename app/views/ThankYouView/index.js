...
import {COLOR_WHITE, NAV_BAR_END, NAV_BAR_START, themes} from '../../constants/colors';
  ...
  return (
    <SafeAreaView
      ...
      <ScrollView
        ...
        <Text style={[styles.subText, {color: themes[theme].activeTintColor}]}>
          * There might be cases your application might not be approved. In that case, the payment will be
          fully refunded.
        </Text>
        <Text style={[styles.subText, {color: themes[theme].activeTintColor}]}>
