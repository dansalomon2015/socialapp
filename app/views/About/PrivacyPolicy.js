    ...
    <View style={{ backgroundColor: themes[theme].backgroundColor }}>
      ...
      <ScrollView style={[styles.container, { marginBottom: 16 }]}>
        <View style={{ marginBottom: 16 }}>
          <Text style={[styles.title, { color: themes[theme].titleColor }]}>Privacy Policy</Text>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            VIP Billionaires ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by VIP
            Billionaires.
          </Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
        ...
        <View style={{ marginBottom: 32 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor }]}>
              Personnel: refers to those individuals who are employed by VIP Billionaires or are under contract to perform a service on behalf of one of the parties.
            </Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor }]}>
              Personal Data: any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or
        ...
        <View style={{ marginBottom: 32 }}>
          <Text style={[styles.title, { color: themes[theme].titleColor }]}>What Information Do We Collect?</Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Name / Username</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Phone Numbers</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Email Addresses</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Job Titles</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Billing Addresses</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Debit/credit card numbers</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Age</Text>
          </View>
          <View style={{ flexDirection: 'row', marginBottom: 16 }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>Password</Text>
          </View>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
        ...
        <View style={{ marginBottom: 16 }}>
          <Text style={[styles.title, { color: themes[theme].titleColor }]}>When does VIP Billionaires use customer information from third parties?</Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a VIP Billionaires customer, we
            receive information from a third party that provides automated fraud detection services to VIP Billionaires. We also occasionally collect information that is made publicly available on
            social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            management, e-mail management, storage marketing, credit card processing, customer service and fulfilling orders for products and services you may purchase through the app. We will likely
            share your personal information, and possibly some non-personal information, with these third parties to enable them to perform these services for us and for you.
          </Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            We may share portions of our log file data, including IP addresses, for analytics purposes with third parties such as web analytics partners, application developers, and ad networks. If
            your IP address is shared, it may be used to estimate general location and other technographics such as connection speed, whether you have visited the app in a shared location, and type of
            the device used to visit the app. They may aggregate information about our advertising and what you see on the app and then provide auditing, research and reporting for us and our
            advertisers. We may also disclose personal and non-personal information about you to government or law enforcement officials or private parties as we, in our sole discretion, believe
            necessary or appropriate in order to respond to claims, legal process (including subpoenas), to protect our rights and interests or those of a third party, the safety of the public or any
            person, to prevent or stop any illegal, unethical, or legally actionable activity, or to otherwise comply with applicable court orders, laws, rules and regulations.
          </Text>
        </View>

        <View style={{ marginBottom: 16 }}>
          <Text style={[styles.title, { color: themes[theme].titleColor }]}>Where and when is information collected from customers and end users?</Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            VIP Billionaires will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            not send unsolicited commercial emails, because we hate spam as much as you do. By submitting your email address, you also agree to allow us to use your email address for customer audience
            targeting on sites like Facebook, where we display custom advertising to specific people who have opted-in to receive communications from us. Email addresses submitted only through the
            order processing page will be used for the sole purpose of sending you information and updates pertaining to your order. If, however, you have provided the same email to us through another
            method, we may use it for any of the purposes stated in this Policy. Note: If at any time you would like to unsubscribe from receiving future emails, we include detailed unsubscribe
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can't identify you.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information
            (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to VIP
            Billionaires or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial
            safeguards.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            make mistakes or fail to follow policies. Therefore, while we use reasonable efforts to protect your personal information, we cannot guarantee its absolute security. If applicable law
            imposes any non-disclaimable duty to protect your personal information, you agree that intentional misconduct will be the standards used to measure our compliance with that duty.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            Customers have the right to request the restriction of certain uses and disclosures of personally identifiable information as follows. You can contact us in order to (1) update or correct
            your personally identifiable information, (2) change your preferences with respect to communications and other information you receive from us, or (3) delete the personally identifiable
            information maintained about you on our systems (subject to the following paragraph), by cancelling your account. Such updates, corrections, changes and deletions will have no effect on
            other information that we maintain, or information that we have provided to third parties in accordance with this Privacy Policy prior to such update, correction, change or deletion. To
            protect your privacy and security, we may take reasonable steps (such as requesting a unique password) to verify your identity before granting you profile access or making corrections. You
            are responsible for maintaining the secrecy of your unique password and account information at all times.
          </Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            You should be aware that it is not technologically possible to remove each and every record of the information you have provided to us from our system. The need to back up our systems to
            protect information from inadvertent loss means that a copy of your information may exist in a non-erasable form that will be difficult or impossible for us to locate. Promptly after
            receiving your request, all personal information stored in databases we actively use, and other readily searchable media will be updated, corrected, changed or deleted, as appropriate, as
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            You may contact us in order to (1) update or correct your information, (2) change your preferences with respect to communications and other information you receive from us, or (3) receive
            a record of the information we have relating to you. Such updates, corrections, changes and deletions will have no effect on other information that we maintain, or information that we have
            provided to third parties in accordance with this Privacy Policy prior to such update, correction, change or deletion.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this
            Privacy Policy.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            The laws of Japan, excluding its conflicts of law rules, shall govern this Agreement and your use of the app. Your use of the app may also be subject to other local, state, national, or
            international laws.
          </Text>
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            By using VIP Billionaires or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website,
            or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform,
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            preferences) if you block cookies on your browser. Different browsers make different controls available to you. Disabling a cookie or category of cookie does not delete the cookie from
            your browser, you will need to do this yourself from within your browser, you should visit your browser's help menu for more information.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            continue to use the Service, you will be bound by the updated Privacy Policy. If you do not want to agree to this or any updated Privacy Policy, you can delete your account.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            ...
            is why we have implemented GDPR controls as our baseline standard for all our operations worldwide.
          </Text>
        </View>
        ...
        <View style={{ marginBottom: 32 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>
              Personal data should only be collected to fulfil a specific purpose and it should only be used for that purpose. Organizations must specify why they need the personal data when they
              collect it.
            </Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <VectorIcon type="MaterialCommunityIcons" name="circle-medium" color={themes[theme].textColor} size={24} />
            <Text style={[styles.listText, { color: themes[theme].textColor, flex: 1 }]}>
              People covered by the GDPR have the right to access their own personal data. They can also request a copy of their data, and that their data be updated, deleted, restricted, or moved to
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <Text style={[styles.text, { color: themes[theme].textColor }]}>
            We are aware that if you are working with EU customers, you need to be able to provide them with the ability to access, update, retrieve and remove personal data. We got you! We've been
            set up as self service from the start and have always given you access to your data and your customers data. Our customer support team is here for you to answer any questions you might
