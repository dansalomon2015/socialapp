...
const BlockView = (props) => {
      ...
      <View style={styles.itemContainer}>
        <View style={styles.itemHeader}>
          ...
          <View style={styles.itemContent}>
            ...
            <Text style={[styles.itemPost, { color: themes[theme].infoText }]}>{`0 ${I18n.t('Posts').toLowerCase()}`}</Text>
          </View>
        </View>
  ...
  return (
    <View
      ...
      <SafeAreaView style={[sharedStyles.contentContainer, { flex: 1, overflow: 'hidden', paddingTop: 20, paddingHorizontal: 10, backgroundColor: themes[theme].backgroundColor }]}>
        <StatusBar />
        {updating && (
