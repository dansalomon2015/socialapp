  ...
  return (
    <View style={{ backgroundColor: themes[theme].backgroundColor }}>
      ...
      <View style={[styles.container, { marginBottom: 16 }]}>
        <Text style={[styles.title, { color: themes[theme].titleColor }]}>Terms of Use</Text>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>Updated at 2021-09-27</Text>
      </View>
      <View style={[styles.container, { marginBottom: 0 }]}>
        <Text style={[styles.title, { color: themes[theme].titleColor, fontSize: 16, fontWeight: '500' }]}>
          General Terms
        </Text>
      </View>
      <ScrollView style={[styles.container, { marginBottom: 16 }]}>
        <Text style={[styles.text, { color: themes[theme].textColor }]}>
          ...
          Like any other website, VipBillionaires uses 'cookies'. These cookies are used to store information including
          ...
          You may consult this list to find the Privacy Policy for each of the advertising partners of VipBillionaires.
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in their respective advertisements and links that appear on VipBillionaires, which are sent directly to users'
          ...
          VipBillionaire's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
